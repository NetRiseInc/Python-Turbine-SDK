...
class QueryActivityActivityEdgesNodeEntityAssetAnalysisCompletedPayload(BaseModel):
    typename__: Literal["AssetAnalysisCompletedPayload"] = Field(alias="__typename")
