...
| `licenseIssue.lastModified` | `typing.Annotated[datetime.datetime, BeforeValidator(func=<function parse_datetime at 0x10b1704a0>, json_schema_input_type=PydanticUndefined)]` | yes |
...
| `licenseIssue.remediation.createdTime` | `typing.Annotated[datetime.datetime, BeforeValidator(func=<function parse_datetime at 0x10b1704a0>, json_schema_input_type=PydanticUndefined)]` | yes |
