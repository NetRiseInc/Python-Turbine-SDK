...
| `licenseIssues.edges[].node.lastModified` | `typing.Annotated[datetime.datetime, BeforeValidator(func=<function parse_datetime at 0x1093f3060>, json_schema_input_type=PydanticUndefined)]` | yes |
...
| `licenseIssues.edges[].node.remediation.createdTime` | `typing.Annotated[datetime.datetime, BeforeValidator(func=<function parse_datetime at 0x1093f3060>, json_schema_input_type=PydanticUndefined)]` | yes |
