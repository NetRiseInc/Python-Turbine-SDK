...
| `dependencies.edges[].node.submitDatetime` | `typing.Annotated[datetime.datetime, BeforeValidator(func=<function parse_datetime at 0x109441940>, json_schema_input_type=PydanticUndefined)]` | yes |
...
def main() -> None:
    ...
    with sdk.graphql() as client:
        ...
        for edge in resp.dependencies.edges or []:
            node = edge.node
            print(node.id, node.ai_architecture, node.correlations_count)
